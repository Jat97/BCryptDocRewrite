...
Sets the pseudo number generator to a random number as a fallback in the event that neither Web Crypto API nor Node.js' built-in crypto library are available. 
